...
export default function CivicMap({ reports, selectedCity, onSelectReport }: CivicMapProps) {
  ...
  return (
    <div className="relative w-full h-full min-h-[480px] md:min-h-[520px] rounded-2xl overflow-hidden shadow-sm border border-slate-200/80 bg-slate-50 transition-all flex flex-col">
